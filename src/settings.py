...
GAMEBALL_RADIUS = 45
GAMEBALL_INIT_X = GAMEBALL_RADIUS # Human player always starts
GAMEBALL_INIT_Y = HEIGHT - GAMEBALL_RADIUS
GAMEBALL_INIT_VEL = vec(10, -12)
GAMEBALL_INIT_ACC = vec(0, GAMEBALL_GRAVITY)
